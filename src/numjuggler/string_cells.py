...
def remove_hash(cards, logfile=""):
    ...
    def remove(card, cname):
        ...
        if (not cardstr.hproc) or (cardstr.stat["hash"] == 0):
            return  # no complementary operator or cannot be # cannot be removed
