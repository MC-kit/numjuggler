...
def get_k(p):
    ...
    A, B, C = ABC
    D, E, F = DEF
    k = numpy.array((A - a2 + D + F, D + B - a2 + E, F + E + C - a2))
    k = k / (k**2).sum() ** 0.5
...
def is_gq_cylinder(p):
    ...
    if not numpy.isclose(d * e * f, -8.0 * (1.0 - a) * (1.0 - b) * (1.0 - c)):
...
def skprime(c):
    ...
    """
    x, y, z = c
    j = numpy.array((0.0, 1.0, 0.0))
    k = numpy.array((0.0, 0.0, 1.0))
    if x == 1.0:
...
def gq_orig(p, c):
    ...
    a, b, C, d, e, f, g, h, j, k = p
    xc, yc, zc = c
    M = numpy.array([[2.0 * a + xc, d + yc, f + zc], [d, 2.0 * b, e], [f, e, 2.0 * C]])
    B = numpy.array((-g, -h, -j))
...
def gq_radius(p, o):
    ...
    xo, yo, zo = o
    rrr = numpy.array(
        (-k, xo**2.0 * a, yo**2.0 * b, zo**2.0 * c, xo * yo * d, xo * zo * f, yo * zo * e)
    )
    r2 = rrr.sum()
    if r2 < 0:
...
if __name__ == "__main__":
    ...
    pd = {}
    pd[517] = (
        "      GQ        0.1266259       0.8843003       0.9890738      -0.6357644 0.0711100       0.1953731       8.9081601     112.2141090 444.8005144   52053.7148001 "
    )
    pd[518] = (
        "      GQ        0.1266259       0.8843003       0.9890738      -0.6357644 0.0711100       0.1953731       8.9081601     112.2141090 444.8005144   51953.7148001 "
    )

    pd[520] = (
        "      GQ        0.1266259       0.8843003       0.9890738      -0.6357644 0.0711100       0.1953731      17.0608040     115.1814287 527.3458317   72336.8646999 "
    )
    pd[521] = (
        "      GQ        0.1266259       0.8843003       0.9890738      -0.6357644 0.0711100       0.1953731      17.0608040     115.1814287 527.3458317   72236.8646999 "
    )

    pd[513] = (
        "      GQ        0.1266259       0.8843003       0.9890738      -0.6357644 0.0711100       0.1953731      -4.7726457     149.8018138 444.8005144   54401.7148002 "
    )
    pd[528] = (
        "      GQ        0.1266259       0.8843003       0.9890738      -0.6357644 0.0711100       0.1953731      -4.7726457     149.8018138 444.8005144   54501.7148002 "
    )

    pd[529] = (
        "      GQ        0.1266259       0.8843003       0.9890738      -0.6357644 0.0711100       0.1953731       3.3799982     152.7691336 527.3458317   74784.8647000 "
    )
    pd[530] = (
        "      GQ        0.1266259       0.8843003       0.9890738      -0.6357644 0.0711100       0.1953731       3.3799982     152.7691336 527.3458317   74684.8647000 "
    )
    pd[532] = (
        "      GQ        0.1266259       0.8843003       0.9890738      -0.6357644 0.0711100       0.1953731       6.8598356     132.6895083 493.1163947   64843.3354134 "
    )

    # GQ from m1_ model in to5
    pd[25177] = (
        "       GQ        0.6951738       0.9781145       0.3267118       0.1633559 -0.2427779       0.9060594   -1292.6456577     346.3633601 -932.2182196  664976.9633871 "
    )
    pd[25185] = (
        "       GQ        0.6951738       0.9781145       0.3267118       0.1633559 -0.2427779       0.9060594   -1282.2945347     343.5897850 -924.7532926  654369.6343547 "
    )
    pd[25183] = (
        "       GQ        0.6951738       0.9781145       0.3267118       0.1633559 -0.2427779       0.9060594   -1276.1553470     366.5015456 -924.7532926  654510.2939547 "
    )
    pd[25187] = (
        "       GQ        0.6951738       0.9781145       0.3267118       0.1633559 -0.2427779       0.9060594   -1279.3802323     354.4661098 -924.7532926  654401.3312546 "
    )
    pd[25179] = (
        "       GQ        0.6951738       0.9781145       0.3267118       0.1633559 -0.2427779       0.9060594   -1289.7313552     357.2396849 -932.2182196  665008.6602870 "
    )
    pd[25181] = (
        "       GQ        0.6951738       0.9781145       0.3267118       0.1633559 -0.2427779       0.9060594   -1285.5553713     369.0202746 -931.5323151  664136.1672603 "
    )
    pd[25099] = (
        "       GQ        0.3874553       0.9391049       0.6734399       0.3862692 0.2820349      -0.8945003    -251.4879218      79.2938372 378.6739698   53230.4757183 "
    )
    pd[25100] = (
        "       GQ        0.3874553       0.9391049       0.6734399       0.3862692 0.2820349      -0.8945003    -210.0745168      66.2362407 316.3163888   37142.2100034 "
    )
